...
function useReactive(state) {
    ...
    const [reactiveState] = react.useState(() => createReactiveObject(state, update));
    return reactiveState;
}
function useBaseReactive(state) {
    const update = useUpdate();
    const [reactiveState] = react.useState(() => createReactiveObject(wrap(state), update));
    return reactiveState;
}

exports.createReactiveStore = createReactiveStore;
exports.createStore = createStore;
exports.useBaseReactive = useBaseReactive;
